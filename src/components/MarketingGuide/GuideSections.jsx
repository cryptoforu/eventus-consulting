    ...
    <Section id={id} ariaLabel={sectionHeading}>
      <Container>
        ...
        <Heading
          headingLevel="h2"
          className={
            "mt-8 font-display text-2xl md:text-4xl font-bold tracking-tight"
          }
        >
        ...
        <Prose
          className={clsx(
            "font-display font-semibold text-slate-700 dark:text-slate-300 relative prose-h2:text-2xl md:prose-h2:text-5xl"
          )}
        >
          {children}
        </Prose>
